...
db.db.open(function(error, database) {
    ...
    function getCollections() {
        ...
        db.apartments = db.database.collection('apartments');
        db.apartmentForms = db.database.collection('apartmentForms');
        db.apartmentUtils = db.database.collection('apartmentUtils');
